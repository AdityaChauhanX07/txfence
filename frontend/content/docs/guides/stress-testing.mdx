...
interface RiskReport {
  survivalRate:    number                    // fraction of scenarios with well-defined results
  byVector:        Record<string, VectorStats>
  bySeverity:      Record<string, number>
  failedScenarios: FailedScenario[]         // sorted by severity
